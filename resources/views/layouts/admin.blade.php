...
<head>
    ...
    <title>@yield('title') - Rumah Gadai Admin</title>
            ...
            <div class="absolute bottom-0 left-0 right-0 border-t border-gray-100">
                <div class="px-4 py-4">
                    <div class="flex items-center">
                        <img src="https://ui-avatars.com/api/?name=Admin&background=ff6b00&color=fff" 
                             alt="Profile" 
                             class="h-10 w-10 rounded-full">
                        <div class="ml-3">
                            <p class="text-sm font-medium text-gray-900">Admin</p>
                            <p class="text-xs text-gray-500">admin@rumahgadai.com</p>
                        </div>
                    </div>
                </div>
            </div>
