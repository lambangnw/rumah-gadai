...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    ...
    <div class="mb-6 flex flex-col md:flex-row gap-4">
        <div class="flex-1">
            <input type="text" placeholder="Cari SBG..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-3">
                            ...
                            <a href="#" class="text-green-600 hover:text-green-900">Setujui</a>
