    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 max-w-6xl mx-auto p-8 mt-0">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500">Semua SBG (Surat Bukti Gadai) yang dikelola supervisor.</p>
            </div>
            <div class="flex gap-2">
                <input type="text" placeholder="Cari SBG..." class="form-input w-full md:w-64 px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 text-gray-800" />
                <div class="relative w-full md:w-48">
                    <select class="form-input w-full pr-10 px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 text-gray-800">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-blue-50 transition {{ $loop->even ? 'bg-gray-50' : 'bg-white' }}">
                        ...
                        <td class="px-6 py-4">
                            @if($trx['status'] === 'Lunas')
                                <span class="inline-block rounded-full px-3 py-1 text-xs font-semibold bg-blue-100 text-blue-700 border border-blue-200 shadow-sm">Lunas</span>
                            @else
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-2">
                                ...
                                <a href="#" class="text-blue-500 hover:text-blue-700" title="Pembayaran">
